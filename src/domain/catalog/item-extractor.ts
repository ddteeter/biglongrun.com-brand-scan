...
- category (string): apparel category — one of: tops, bottoms, shorts, outerwear, accessories, footwear, base-layer. Use the most specific label that fits; default to "accessories" only if none of the above apply.
